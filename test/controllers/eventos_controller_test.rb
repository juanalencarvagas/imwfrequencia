...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { data: @evento.data, descricao: @evento.descricao, id_tipo_evento: @evento.id_tipo_evento } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { data: @evento.data, descricao: @evento.descricao, id_tipo_evento: @evento.id_tipo_evento } }
