...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { cargo: @pessoa.cargo, depto: @pessoa.depto, tipo: @pessoa.tipo } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { cargo: @pessoa.cargo, depto: @pessoa.depto, tipo: @pessoa.tipo } }
